...
function Detail(){
  const { id } = useParams(); // 엔드포인트에 값을 더해주기 위함
  const [ loading, setLoading ] = useState(true);
  const [ movie, setMovie] = useState(null); // 상위 컴포넌트 내에 객체로 선언되어있어서 null로 작성함
          ...
          <div className="detail-content">
            ...
            <div className="detail-info">
              ...
              <p className="detail-meta">
                ⭐ {movie.rating} 정 / ⏰ {movie.runtime} 분
              </p>
